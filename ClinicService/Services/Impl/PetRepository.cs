...
namespace ClinicService.Services.Impl
{
    public class PetRepository : IPetRepository
    {
        ...
        public int Create(Pet item)
        {
            ...
            command.CommandText = "INSERT INTO pets(ClientId, Name, Birthday) VALUES(@ClientId, @SurName, @Name, @Birthday)";
        ...
        public IList<Pet> GetAll()
        {
            ...
            while (sQLiteDataReader.Read())
            {
                ...
                pet.ClientId = sQLiteDataReader.GetInt32(0);
                pet.Name = sQLiteDataReader.GetString(2);
                pet.Birthday = new DateTime(sQLiteDataReader.GetInt64(5));
                list.Add(pet);
            }
            connection.Close();
            return list;
